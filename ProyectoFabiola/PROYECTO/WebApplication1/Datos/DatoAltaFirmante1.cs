...
namespace Datos
{
    public class DatoAltaFirmante1
    {

        public DatoAltaFirmante1()
        {}
        ...
        public int InsertFirmante1(int ID_PLANTEL, int ID_AREA, string RFC_PEC, string RFC_CONSEJERO1, string RFC_CONSEJERO2,
             string RFC_CONSEJERO3, string RFC_CONSEJERO4, string RFC_CONSEJERO5, string RFC_CONSEJERO6, string SIGLAS, DateTime FECHA_OFICIO, int ID_PERIODO)
        {
            ...
            paramRFC_CONSEJERO4.Value = RFC_CONSEJERO2;
            ...
            paramRFC_CONSEJERO6.Value = RFC_CONSEJERO2;
        ...
        return ejecutaNonQuery("AltasFIRMANTES1", parametros);
        }

        public List<Firmantes1> select_All_Firmantes1()
        {
            List<Firmantes1> LstFirmantes1 = new List<Firmantes1>();

            string StoredProcedure = "ObtenerFirmante";
            using (DbConnection con = dpf.CreateConnection())
            {
                ...
                using (DbCommand cmd = dpf.CreateCommand())
                {
                    ...
                    using (DbDataReader dr = cmd.ExecuteReader())
                    {
                        while (dr.Read())
                        {
                            LstFirmantes1.Add(new Firmantes1((int)dr["ID_PLANTEL"], (int)dr["ID_AREA"],(string)dr["RFC_PEC"], (string)dr["RFC_CONSEJERO1"],
                                (string)dr["RFC_CONSEJERO2"],(string)dr["RFC_CONSEJERO3"],
                                (string)dr["RFC_CONSEJERO4"],(string)dr["RFC_CONSEJERO5"],(string)dr["RFC_CONSEJERO6"],(string)dr["SIGLAS"],
                                (DateTime)dr["FECHA_OFICIO"],(int)dr["ID_PERIODO"]));
