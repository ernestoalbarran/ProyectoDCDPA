       ...
       <div class="panel panel-info">
           ...
           <div class="panel-body">
                <div class=" col-md-10 col-lg-10 "> 
                        ...
                        <asp:GridView ID="GridProyectos" runat="server" EmptyDataText="No existen Proyectos" OnRowCommand="GridProyectos_RowCommand">
                        <Columns>
                  ...
                  <asp:TemplateField HeaderText="PLANTEL" HeaderStyle-Width="200px">
                      <ItemTemplate>
